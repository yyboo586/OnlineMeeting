...
CREATE TABLE `t_meeting_participant` (
    ...
    `accept_time` datetime COMMENT '接受/拒绝时间',
...
select 
    t1.room_number, t1.topic, t1.status, t2.user_id, t2.user_name, t2.role, t2.status 
from 
    t_meeting as t1 left join t_meeting_participant t2 
on t1.room_number = t2.m_room_number;